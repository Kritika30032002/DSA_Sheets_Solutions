...
// structure for the node of deque
...
class Deque 
{
    ...
    // pointers to head and tail of deque
        ...
        void insert_first(int element)
        {
            ...
            // allocating node of DequeNode type

            DequeNode *temp = new DequeNode[sizeof(DequeNode)];
            temp->value = element;
...
class Queue:public Deque 
{
    ...
    // enqueue to insert element at last position of queue using insert at last function of deque
    ...
    // dequeue to remove element at first position of queue using remove at first function of deque
